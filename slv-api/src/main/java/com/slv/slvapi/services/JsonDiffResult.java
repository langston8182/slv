...
public class JsonDiffResult {
   ...
   * 
   * @param equals
   *          status of the comparison : <code>true</code> if Json attributes
   *          are equals in the two Json {@link String}, <code>false</code>
   *          otherwise
   * @param errorMessage
   *          Blank if {@link #equals} is <code>true</code>, otherwise formatted
   *          message containing information on the differences
   */
